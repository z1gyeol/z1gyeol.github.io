...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		{
			src: '/favicon/F5EA1421-E3E0-464A-84BE-94D6452CF6DE.jpg'
		}
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/prof.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "z1gyeol",
	bio: "student",
	links: [
		/*{
